...
export default function Edit(props) {
  ...
  return (
    <div {...useBlockProps({ className: "alignfull" })}>
      ...
      <div className="wp-block-ns-vertical-anchor__wrapper">
        <div className="wp-block-ns-vertical-anchor__items">
          {anchorLinks.map((link, index) => {
            return (
              <div key={index} className="wp-block-ns-vertical-anchor__item">
                <div className="wp-block-ns-vertical-anchor__link">{link.text}</div>
              </div>
            )
          })}
        </div>
