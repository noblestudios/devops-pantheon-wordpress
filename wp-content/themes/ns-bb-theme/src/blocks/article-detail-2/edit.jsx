...
export default function Edit(props) {
  ...
  return (
    <div {...useBlockProps({ className: "alignfull" })}>
      ...
      <div className="wp-block-ns-article-detail-2__hero --theme-background-image-desktop">
        <div className="wp-block-ns-article-detail-2__featured-image">
          <img src="https://pd.w.org/2023/12/84965771299917fb0.70252333-1536x1063.jpg" alt="" />
        </div>
        <div className="wp-block-ns-article-detail-2__title --hl-xxl">Ad pariatur duis dolore quis</div>
      </div>
      <div className="wp-block-ns-article-detail-2__columns">
        <div className="wp-block-ns-article-detail-2__content">
          <div className="wp-block-ns-article-detail-2__byline">
            <>
              Posted January 31, 2023 in <span className="wp-block-ns-article-detail-2__byline-link">Category</span>,{" "}
              <span className="wp-block-ns-article-detail-2__byline-link">Category</span> by{" "}
              <span className="wp-block-ns-article-detail-2__byline-link">Author Name</span>
            </>
          </div>
          <p>
        ...
        <div className="wp-block-ns-article-detail-2__sidebar">
          {showSocials && (
