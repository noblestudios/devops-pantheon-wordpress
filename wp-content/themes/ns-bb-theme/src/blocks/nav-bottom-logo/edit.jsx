...
export default function Edit(props) {
  ...
  return (
    <div {...useBlockProps({ className: "alignfull" })}>
      ...
      <div className="wp-block-ns-nav-bottom-logo__width js-sticky-nav-wrap">
        <nav id="js-secondaryNav" className="wp-block-ns-nav-bottom-logo__secondary-header --background-two">
          <div className="wp-block-ns-nav-bottom-logo__secondary-header-width">
            <div className="wp-block-ns-nav-bottom-logo__secondary-menu-items">
              {secondaryMenuItems !== null &&
                secondaryMenuItems !== undefined &&
                secondaryMenuItems.map((item) => {
                  return (
                    <div key={item.id} className="wp-block-ns-nav-bottom-logo__secondary-menu-item">
                      <span className="wp-block-ns-nav-bottom-logo__secondary-menu-item-link">{item.title.raw}</span>
                    </div>
                  )
                })}
              <div className="wp-block-ns-nav-bottom-logo__secondary-menu-item --phone-row">
                <span className="wp-block-ns-nav-bottom-logo__secondary-menu-item-link --phone">
        ...
        <nav id="js-mainNav" className="wp-block-ns-nav-bottom-logo__header">
          <div className="wp-block-ns-nav-bottom-logo__header-width">
            <div className="wp-block-ns-nav-bottom-logo__logo">
            ...
            <div className="wp-block-ns-nav-bottom-logo__menu --background-two-mobile">
              <div className="wp-block-ns-nav-bottom-logo__menu-items --right">
                <div className="wp-block-ns-nav-bottom-logo__menu-item --phone-row">
                  <span className="wp-block-ns-nav-bottom-logo__menu-item-link --phone">(555) 555-5555</span>
                </div>
                <div className="wp-block-ns-nav-bottom-logo__menu-item --search-row">
                  <form className="wp-block-ns-nav-bottom-logo__mobile-search" action="/" method="get">
                ...
                {menuItems !== undefined &&
                  ...
                  menuItems.map((item) => {
                    if (!item.parent) {
                      return (
                        <div key={item.id} className="wp-block-ns-nav-bottom-logo__menu-item">
                          <span className="wp-block-ns-nav-bottom-logo__menu-item-link">{item.title.raw}</span>
                        </div>
                      )
                    }
                    return <></>
            ...
            <button
              className="wp-block-ns-nav-bottom-logo__search-btn js-tgglSrch"
              type="button"
              aria-label="open search"
            ></button>
            {navCTALabel && (
              <span
                className={`wp-block-ns-nav-bottom-logo__mobile-cta --micro-cta ${navMobileCTA ? "--show-mobile" : ""}`}
              >
                {navCTALabel}
              </span>
            )}
            {navMobilePhone && <span className="wp-block-ns-nav-bottom-logo__mobile-phone"></span>}
            <div id="js-mobileMenuTrggr" className="wp-block-ns-nav-bottom-logo__mobile-trigger">
